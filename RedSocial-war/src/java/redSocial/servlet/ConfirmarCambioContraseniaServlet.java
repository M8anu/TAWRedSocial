 ...
 * @author Senan
 */
@WebServlet(name = "ConfirmarCambioContraseniaServlet", urlPatterns = {"/ConfirmarCambioContraseniaServlet"})
public class ConfirmarCambioContraseniaServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Usuario us = usuarioFacade.find(id);
        
        us.setPassword(nuevaPass);
